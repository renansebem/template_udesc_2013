...
\assinaturamembrotipodois{Prof. Dr. Nome do Membro \\ Universidade do Estado de Santa Catarina}
\assinaturamembrotipodois{Prof. Dr. Nome do Membro \\ Universidade do Estado de Santa Catarina}
\end{minipage}\begin{minipage}{\textwidth/2}
\assinaturamembrotipodois{Prof. Dr. Nome do Membro \\ Universidade do Estado de Santa Catarina}
\assinaturamembrotipodois{Prof\textsuperscript{a}. Dr\textsuperscript{a}. Nome do Membro \\ Universidade do Estado de Santa Catarina}
\end{minipage}
